// lib/features/analytics/views/monthly_report_screen.dart
...
class MonthlyReportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final trips = controller.getMonthTrips();
        ...
        actions: [
          if (trips.isNotEmpty)
            PopupMenuButton<String>(
              ...
              onSelected: (value) {
                if (value == 'excel') {
                  controller.exportExcel(trips, 'Monthly_Report');
                } else {
                  controller.exportPDF(trips, 'Monthly Report');
                }
              },
              itemBuilder: (context) => [

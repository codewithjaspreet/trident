// lib/features/analytics/views/weekly_report_screen.dart
...
class WeeklyReportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final trips = controller.getWeekTrips();
        ...
        actions: [
          if (trips.isNotEmpty)
            PopupMenuButton<String>(
              ...
              onSelected: (value) {
                if (value == 'excel') {
                  controller.exportExcel(trips, 'Weekly_Report');
                } else {
                  controller.exportPDF(trips, 'Weekly Report');
                }
              },
              itemBuilder: (context) => [
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Text(DateFormat('MMM dd').format(trip.tripDate),
                    style: TextStyle(fontSize: 13.sp, color: const Color(0xFF64748B))),
              ],
            ),
          ),

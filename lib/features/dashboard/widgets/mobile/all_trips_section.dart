...
import 'driver_assigned_trip_card.dart';
      ...
      return SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            dashBoardController.loggedInUser.value.userRole != 'driver' && navigationController.currentIndex.value == 0
                ? const AddTrip()
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      ...
                      if(role == 'driver') {
                        ...
                        await dashBoardController.getAllCreatedTrips();
                      }
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return dashBoardController
                      .loggedInUser.value.userRole ==
                      'admin' || dashBoardController.loggedInUser.value.userRole == 'Trip Manager'
                      ? TripCard(trip: trip) :
